...
2. A new Project should open. Run `renv::restore()` to download the necessary packages with their versions in one step.  When prompted if you want to proceed with installing packages, enter "Y" (for yes) on the R console.
